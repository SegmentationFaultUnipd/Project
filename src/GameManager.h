...
namespace chess {
    ...
    class GameManager {
        public:
            ...
            GameManager(Player &player1, Player &player2, int max_moves) : player1_(player1), player2_(player2), max_moves_(max_moves), current_player(selectStartingPlayer(player1, player2)) {
				createLogFile();
			}
           	void play();
