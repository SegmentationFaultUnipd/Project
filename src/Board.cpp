...
{
    // Aggiorna la posizione nei dati membro
    at(from).move(to, *this);

    // Aggiorna la posizione nella lista delle coordinate
...
{
    // Avendo due pezzi dello stesso tipo, se uno può mangiare l'altro, allora è vero anche viceversa.
    // Così creiamo dei pezzi nella posizione specificata, controlliamo quali pezzi potrebbe catturare,
    // Se tra questi ce n'è uno dello stesso tipo, significa che la posizione è minacciata
    ...
    // Gli en passants sono un'eccezzione alla regola detta in precedenza
